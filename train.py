...
def train(gpu, args):
    ...
    while should_keep_training:
        ...
        if not args.no_ddp:
            ...
            train_loader = DataLoader(db, batch_size=cfg.SOLVER.BATCH_SIZE, sampler=train_sampler, num_workers=args.num_workers, pin_memory=True)
        else:
            train_loader = DataLoader(db, batch_size=cfg.SOLVER.BATCH_SIZE, num_workers=1,shuffle=False)
