...
cfg.MODELS.D_MODEL = 256
cfg.MODELS.D_FFN = 256
cfg.MODELS.NHEAD = 8
cfg.MODELS.LAYER_NAMES = ['self', 'cross'] * 1
cfg.MODELS.LAYER_NAMES2 = ['self', 'cross'] * 3
cfg.MODELS.ATTENTION = 'linear'  # options: ['linear', 'full']
cfg.MODELS.TEMP_BUG_FIX = True

cfg.LOSS = CN()
cfg.LOSS.LOSSES = ["train_geo_loss_tr","train_geo_loss_rot"]
...
cfg.DATASETS = CN()
cfg.DATASETS.INPUT_WIDTH = 640
cfg.DATASETS.INPUT_HEIGHT = 480
...
cfg.SOLVER.BATCH_SIZE = 6
cfg.SOLVER.WEIGHT_DECAY = 1e-4
cfg.SOLVER.EPOCHS = 20
